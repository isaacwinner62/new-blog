...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Visit Us",
      details: "123 Blog Street, Content City, CC 12345",
  ...
  const contactReasons = [
    {
      ...
      description: "Questions about our content, services, or anything else",
    },
    {
      icon: Users,
      title: "Partnership",
    ...
    },
    {
      icon: Briefcase,
      title: "Business",
      description: "Advertising opportunities, sponsorships, or business proposals",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Have a question, suggestion, or just want to say hello? We'd love to hear from you. Our team is here to
              help and we typically respond within 24 hours.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Whether you're a reader, potential partner, or business looking to collaborate, we're here for you.
            </p>
          </div>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-indigo-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
                      <>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Yes! We welcome high-quality guest contributions. Please include writing samples in your inquiry.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Can I advertise on your site?</h4>
                    <p className="text-gray-600 text-sm">
